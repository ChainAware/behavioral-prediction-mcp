...
- [ ] `openai.yaml` → all 14 capabilities listed (`predictive_fraud`, `predictive_behaviour`, `predictive_rug_pull`, `credit_score`, `token_rank_list`, `token_rank_single`, `predictive_fraud_batch`, `predictive_behaviour_batch`, `check_job_status`, `get_job_results`, `run_token_audit`, `get_token_audit_result`, `agents_trust_score_list`, `agents_trust_score_single`)
- [ ] `openai.yaml` → all 34 subagents listed
...
| `subagents` | 34 specialist agents |
