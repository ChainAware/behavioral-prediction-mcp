...
- [Agent Trust Score for Agentic Commerce](https://chainaware.ai/blog/agent-trust-score-agentic-commerce/) — ERC-8004 agent screening: 274k+ registered agents, trust tiers, fleet-level fraud detection, DeFi access control using `agents_trust_score_list` / `agents_trust_score_single`
- [Token Audit: 10,000 CoinGecko Token Results](https://chainaware.ai/blog/token-audit-10000-coingecko-results/) — Real-world study: 55% of top tokens HIGH RISK; 127 automated checks via `run_token_audit`
